      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-yellow-400 mb-4">Agrikima</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-green-300 hover:text-yellow-300 transition-colors">Home</Link></li>
              <li><Link to="/products" className="text-green-300 hover:text-yellow-300 transition-colors">Products</Link></li>
              <li><Link to="/about" className="text-green-300 hover:text-yellow-300 transition-colors">About Us</Link></li>
              <li><Link to="/farmer-forum" className="text-green-300 hover:text-yellow-300 transition-colors">Farmer Forum</Link></li>
              <li><Link to="/contact" className="text-green-300 hover:text-yellow-300 transition-colors">Contact</Link></li>
            </ul>
          </div>
